...
BEGIN
  SELECT c.Mark,
    ...
    c.AverageConsumption, c.OdometerPreviousMonth, c.OdometerCurrentMonth, (c.OdometerCurrentMonth - c.OdometerPreviousMonth) * (f.Price * c.AverageConsumption / 100 ) as PricePerMonth
  FROM  Car c
